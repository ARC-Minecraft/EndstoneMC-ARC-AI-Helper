...
一个为 Endstone 服务器提供 **弧光 Agent** 的插件（当前 **v2.3.8**）。AI 已从「聊天助手」升级为可操作本服的 **Agent**：查服、执行指令、银行/领地/传送/天眼/监狱等均可工具化调用。
...
- 银行 / 领地 / 传送 / 扩展天眼需弧光核心 ≥ **0.8.12**；地标清单需 ≥ **0.8.13**；天眼模糊名 / 按事件类型全服查询需 ≥ **0.9.28**。
